			...
			<div class="tabbedPanels">  <!-- begins the tabbed panels / wrapper-->
				...
				<div class="panelContainer">
					...
					<div id="panel2" class="panel">
						<p><?= do_shortcode('[contact-form-7 id="793" title="Vacancy FC"]')?></p>
					</div> <!-- end panel 2 -->
				</div>
...
<script>
  async function openPopup (divPopup, productId) {
    ...
    let response = await fetch('<?=get_template_directory_uri()?>/inc/vacancy_details_request_handler.php', {
      method: 'POST',
      mode: 'same-origin',
