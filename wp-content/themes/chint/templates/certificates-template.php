                ...
                <div class="row">
                    ...
                    if(have_rows('certificates')){
                        while (have_rows('certificates')){
                            ...
                            ?>
                            <div class="views-stories-row case-studies-box-wrap products-wrap col-md-3">
                                <a href="#" class="case-studies-box">
                                    <div class="case-studies-image-wrap" style="padding: 20px;">
                                        <!-- <span>
											Switches & Sockets
										</span> -->
                                        <img src="<?=$certificate_image?>" alt="Certificate Image">
                                    </div>
                                </a>
                            </div>
                            <?php
