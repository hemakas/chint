    ...
    <section class="about">
        <div class="container">
            ...
            <div class="row">
				...
				<?php
				if ( have_rows( 'customer_details' ) ) {
					while ( have_rows( 'customer_details' ) ) {
						the_row();
						$customer_name     = get_sub_field( 'customer_name' );
						$customer_location = get_sub_field( 'customer_location' );
                        ...
                        <div class="views-stories-row case-studies-box-wrap products-wrap col-md-6">
                            <a href="#" class="case-studies-box">
                                ...
                                <span>
                                    <?=$customer_name?> <br> <b><?=$customer_location?></b>
                                </span>
                                    <img src="<?=$featured_image?>" alt="<?=$customer_name?> - Featured image">
                                </div>
                            </a>
                        </div>
